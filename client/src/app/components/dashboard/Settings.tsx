      ...
      <div className="h-full bg-white p-6 shadow-md rounded-lg">
        {!organization.samlConfigured ? (
          <div className="flex flex-col h-full justify-center items-center">
            <IoSettings color="#13e5c0" size={250} />
            <button
          ...
          <div
            onClick={() => setShowSAMLForm(true)}
            className="cursor-pointer flex font-bold justify-center w-full text-white py-2 px-4 rounded-md shadow-sm bg-[#19303d] focus:outline-none focus:ring-2  focus:ring-offset-2"
          >
